...
const StudentFormStepper: React.FC = ({ }) => {
  ...
  const [isMinor, setIsMinor] = useState<boolean | null>(false);
  ...
  const handleMinorChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const isMinor = e.target.value === "1";
    setIsMinor(isMinor);
    setMinorState(isMinor);
  ...
  const handleButtonClick = async () => {
    if (currentStep === 1 && isMinor === false) {
          ...
          >
            {currentStep === 1 && (
              <div className="form-step">
                ...
                <span className="flex ml-4 gap-4 mt-8">
                  <p className=" ml-4 mb-2 font-medium">O aluno é menor de idade?</p>
                  <span>
                    <input type="radio" id="menor_de_idade" value="1" name="minor" onChange={handleMinorChange} />
                    <label htmlFor="menor_de_idade">Sim</label>
                  </span>
                  <span>
                    <input type="radio" id="maior_de_idade" value="2" name="minor" onChange={handleMinorChange} />
                    <label htmlFor="maior_de_idade">Não</label>
                  </span>
                </span>
              </div>
            )}
