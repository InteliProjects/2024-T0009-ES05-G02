...
const CourseCard: React.FC<CardProps> = ({data}) =>{
    ...
    const categoryColors = [
        ...
        {id: '2', category: 'Dança', color: 'bg-[#63236F]', pattern: 'bg-music'},
        {id: '3', category: 'Música', color: 'bg-[#EB1C68]', pattern: 'bg-music'},
        {id: '4', category: 'Tecnologia', color: 'bg-[#FABE28]', pattern: 'bg-tech'}
    ];
    ...
    return (
        <button className='flex bg-white shadow-shadow-25 rounded-3xl w-[200px] h-[100px]'>
                <div className={`${currentCategory?.color} ${currentCategory?.pattern} rounded-l-3xl w-[50%] h-[100px]`}/>
                <div className='flex flex-col rounded-r-3xl w-[100%] h-[100px] self-end justify-center p-2'>
